    ...
    <el-tabs v-model="activeTab">
      ...
      <el-tab-pane label="目录导入" name="import">
        <el-form :model="importForm" label-width="120px" class="import-form">
          ...
          <el-form-item label="并发数" v-if="importForm.generate_caption">
            <el-input-number v-model="importForm.concurrency" :min="1" :max="16" />
            <span class="form-tip">同时处理的图片数量（建议设置为 VLM 实例数）</span>
          </el-form-item>
          <el-form-item>
      ...
      <el-tab-pane label="批量生成描述" name="captions">
        <el-form :model="captionForm" label-width="120px" class="import-form">
          ...
          <el-form-item label="并发数">
            <el-input-number v-model="captionForm.concurrency" :min="1" :max="16" />
            <span class="form-tip">同时处理的图片数量（建议设置为 VLM 实例数）</span>
          </el-form-item>
          <el-form-item>
